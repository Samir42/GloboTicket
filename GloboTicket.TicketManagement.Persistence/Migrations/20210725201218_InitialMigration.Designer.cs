...
namespace GloboTicket.TicketManagement.Persistence.Migrations
{
    ...
    [Migration("20210725201218_InitialMigration")]
            ...
            modelBuilder.Entity("GloboTicket.TicketManagement.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Artist = "John Egbert",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2022, 1, 26, 0, 12, 18, 485, DateTimeKind.Local).AddTicks(1553),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2022, 4, 26, 0, 12, 18, 485, DateTimeKind.Local).AddTicks(9517),
                        ...
                        new
                        {
                            ...
                            Artist = "DJ 'The Mike'",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2021, 11, 26, 0, 12, 18, 485, DateTimeKind.Local).AddTicks(9586),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2021, 11, 26, 0, 12, 18, 485, DateTimeKind.Local).AddTicks(9607),
                        ...
                        new
                        {
                            ...
                            Artist = "Many",
                            CategoryId = new Guid("fe98f549-e790-4e9f-aa16-18c2292a2ee9"),
                            Date = new DateTime(2022, 5, 26, 0, 12, 18, 485, DateTimeKind.Local).AddTicks(9624),
                        ...
                        new
                        {
                            ...
                            Artist = "Nick Sailor",
                            CategoryId = new Guid("6313179f-7837-473a-a4d5-a5571b43e6a6"),
                            Date = new DateTime(2022, 3, 26, 0, 12, 18, 485, DateTimeKind.Local).AddTicks(9644),
            ...
            modelBuilder.Entity("GloboTicket.TicketManagement.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2021, 7, 26, 0, 12, 18, 486, DateTimeKind.Local).AddTicks(1086),
                            OrderTotal = 400,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2021, 7, 26, 0, 12, 18, 486, DateTimeKind.Local).AddTicks(1926),
                            OrderTotal = 135,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2021, 7, 26, 0, 12, 18, 486, DateTimeKind.Local).AddTicks(1964),
                            OrderTotal = 85,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2021, 7, 26, 0, 12, 18, 486, DateTimeKind.Local).AddTicks(1983),
                            OrderTotal = 245,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2021, 7, 26, 0, 12, 18, 486, DateTimeKind.Local).AddTicks(2001),
                            OrderTotal = 142,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2021, 7, 26, 0, 12, 18, 486, DateTimeKind.Local).AddTicks(2020),
                            OrderTotal = 40,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2021, 7, 26, 0, 12, 18, 486, DateTimeKind.Local).AddTicks(2037),
                            OrderTotal = 116,
                            UserId = new Guid("7aeb2c01-fe8e-4b84-a5ba-330bdf950f5c")
                        });
                });
